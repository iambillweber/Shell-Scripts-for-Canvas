...
while read URL TOKEN SUBACCT_ID EMAIL COURSE_CODE ENROLLMENT_TYPE
do
...
curl -H 'Authorization: Bearer '$TOKEN "https://$URL.instructure.com/api/v1/courses/$C_ID/enrollments" \
     -X "POST" \
